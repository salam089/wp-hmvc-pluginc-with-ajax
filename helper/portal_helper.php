...
function cmp_errorFormat($msg) {
	return '<div class="alert alert-danger"> '.$msg.'</div>';
}

function cmp_successFormat($msg) {
	return '<div class="alert alert-success"> '.$msg.'</div>';
}

function cmp_infoFormat($msg) {
	return '<div class="alert alert-info"> '.$msg.'</div>';
}

function cmp_checkCaptcha () {
...
function cmp_captchaErrorMsg() {
	return "Please complete the CAPTCHA.";
}

function cmp_invalidUrlMsg() {
...
function cmp_strleft($s1, $s2) { 
    return substr($s1, 0, strpos($s1, $s2)); 
}

function cmp_base64url_encode($data) { 
  return rtrim(strtr(base64_encode($data), '+/', '-_'), '='); 
}

function cmp_base64url_decode($data) { 
  return base64_decode(str_pad(strtr($data, '-_', '+/'), strlen($data) % 4, '=', STR_PAD_RIGHT)); 
} 
 
function cmp_enquirySubjects() {
	$array = array(
...
* @Author: Atiqur Sumon
*/
function cmp_currencySymbol($currency) 
{
...
* @Author: Atiqur Sumon
*/
function cmp_invoiceStatusLabel($key) 
{
	$array = array(
		0 => "Due",
		1 => "Paid",
...
* @Author: Atiqur Sumon
*/
function cmp_getEmailsAsArray ($em, $em_cc) {
...
* @Author: Atiqur Sumon
*/
function cmp_paymentMethodLabel($key) {
	$array = array(
		'BB' => "Cheque",
		'DD' => "Direct debit",
		'FF' => "Standing order",
...
* @Author: Atiqur Sumon
*/
/*function cmp_clientTableFields() 
{
	$array = array(
		// Contact details
		'contact_name',
...
* @Author: Atiqur Sumon
*/
function cmp_formatCompTime($second) {
	if ($second < 60)
		$output = $second . " sec";
...
* @Author: Atiqur Sumon
*/
function cmp_formatMinuteSecond($second) {
...
* @Author: Atiqur Sumon
*/
function cmp_formatHourMinute($second) {
...
* @Author: Atiqur Sumon
*/
function cmp_formatDayHour($second) {
...
* @Author: Atiqur Sumon
*/
function cmp_formatMonthDay($second) {
...
* @Author: Atiqur Sumon
*/
function cmp_formatYearMonth($second) {
