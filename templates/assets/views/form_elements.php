...
<div class="breadcrumb-wrapper">
    <h4 class="mainTitle no-margin" translate="sidebar.nav.forms.ELEMENTS">FORM ELEMENTS</h4>
                    ...
                    <div class="row margin-top-30">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <p class="text-small margin-bottom-20">
                                        All textual <code> &lt;input&gt; </code>
                                        , <code> &lt;textarea&gt; </code>
                                        , and <code> &lt;select&gt; </code>
                                        elements with <code> .form-control </code>
                                        are set to <code> width: 100%; </code>
                                        by default. Wrap labels and controls in <code> .form-group </code>
                                        for optimum spacing.
                                    </p>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <p class="text-small margin-bottom-20">
                                        ...
                                        controls in a horizontal layout by adding <code> .form-horizontal </code>
                                        to the form. Doing so changes <code> .form-group </code>
                                        s to behave as grid rows, so no need for <code> .row </code>
                                        .
                                    </p>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <p class="text-small margin-bottom-20">
                                        Add <code> .form-inline </code>
                                        to your <code> &lt;form&gt; </code>
            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <p class="margin-bottom-30">
                        <code> &lt;fieldset&gt; </code>
                        is used as a wrapper right inside the form element. Right after you define a fieldset, you can
                        include a legend title by using <code> &lt;legend&gt; </code>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="checkbox clip-check check-primary">
                                                <input type="checkbox" id="read-condition" value="1">
                                                <label for="read-condition">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4">
                            <div class="panel panel-white height-250">
                                <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-sm-6">
                                                    <input type="text" placeholder="Text Field" id="form-field-7"
                                                           class="form-control">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="Click me!" uib-tooltip="See? Now click away..."
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="Click me!" popover-title="Title"
                                                   popover-placement="top" uib-popover="Hello, World!"
                                                   class="form-control"/>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="panel panel-transparent">
                                ...
                                <div class="panel-body">
                                    <p class="text-small">
                                        Use the <code> .checkbox-inline </code>
                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-transparent">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="checkbox">
                                        <switch ng-model="switchsetting" ng-init="switchsetting = true"
                                                class="green"></switch>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-transparent">
                                ...
                                <div class="panel-body">
                                    ...
                                    <!-- /// controller:  'ButtonsCtrl' -  localtion: assets/js/controllers/bootstrapCtrl.js /// -->
                                    <div ng-controller="ButtonsCtrl">
                                        <div class="btn-group">
                                            <label class="btn btn-primary" ng-model="checkModel.left" uib-btn-checkbox>
                                                Left
                                            </label>
                                            ...
                                            <label class="btn btn-primary" ng-model="checkModel.right" uib-btn-checkbox>
                                                Right
                                            </label>
                                        </div>
                                        <pre class="margin-top-10">{{checkModel}}</pre>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="panel panel-transparent">
                                ...
                                <div class="panel-body">
                                    <p class="text-small">
                                        Use the <code> .radio-inline </code>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="panel panel-transparent">
                                ...
                                <div class="panel-body">
                                    <div class="radio clip-radio radio-primary radio-sm radio-inline">
                                    ...
                                    <div class="radio clip-radio radio-primary radio-inline">
                                        <input type="radio" id="radio14" name="radiosize" value="radio13">
                                        <label for="radio14">
                                            Radio 1
                                        </label>
                                    </div>
                                    <div class="radio clip-radio radio-primary radio-md radio-inline">
                                        <input type="radio" id="radio15" name="radiosize" value="radio14">
                                        <label for="radio15">
                                            Radio 2
                                        </label>
                                    </div>
                                    <div class="radio clip-radio radio-primary radio-lg radio-inline">
                                        <input type="radio" id="radio16" name="radiosize" value="radio15">
                                        <label for="radio16">
                                            Radio 3
                                        </label>
                                    </div>
                                ...
                                <div class="panel panel-transparent">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="btn-group margin-bottom-10">
                                            <label class="btn btn-primary" ng-model="radioModel" uib-btn-radio="'Left'">
                                                Left
                                            </label>
                                        ...
                                        <pre class="margin-top-10">{{radioModel || 'null'}}</pre>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="masked"
                                                   placeholder="99/99/9999" ui-mask="99/99/9999" ng-model="x">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="masked"
                                                   placeholder="(999) 999-9999" ui-mask="(999) 999-9999" ng-model="x">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="masked"
                                                   placeholder="A*-999-A999" ui-mask="A*-999-A999" ng-model="x">
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-transparent">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group" ng-controller="SelectCtrl" ng-init="myPeople = people[2]">
                                        <label for="form-field-select-1">
                                            Skin Slide with dynamic options
                                        </label>
                                        <select class="cs-select cs-skin-slide"
                                                ng-options="item.name for item in people" ng-model="myPeople">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="cs-select cs-skin-elastic">
                                            ...
                                            <option value="south-africa" data-class="fa fa-dropbox">South Africa
                                            </option>
                                            <option value="shopping" data-class="fa fa-github">Shopping</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" ng-controller="SelectCtrl">
                                        <label for="form-field-select-1">
                                            Skin Elastic with dynamic options
                                        </label>
                                        <select class="cs-select cs-skin-elastic"
                                                ng-options="item.name for item in peopleAsync" ng-model="myPeople2">
                                            <option value="" disabled="">Select</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <p class="margin-bottom-30">
                        A mobile and touch friendly input spinner component for Bootstrap. It supports the mousewheel
                    ...
                    <div class="row">
                            ...
                            <div class="panel panel-white min-height-270">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="demo1" type="text" value="55" name="demo1" touchspin data-min="0"
                                               data-max="100" data-step="0.1" data-decimals="2" data-boostat="5"
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="panel panel-white min-height-270">
                                ...
                                <div class="panel-body">
                                    <p class="margin-bottom-30">
                                        Use the <code> data-postfix </code>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="panel panel-white min-height-270">
                                ...
                                <div class="panel-body">
                                    <p class="margin-bottom-30">
                                        Set the <code> data-verticalbuttons </code>
                                        attribute as <code> true </code>.
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="panel panel-white min-height-270">
                                ...
                                <div class="panel-body">
                                    <p class="margin-bottom-30">
                                        Set the <code> data-postfix </code>
                                        attribute as <code> button </code>.
