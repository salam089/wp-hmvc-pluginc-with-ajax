...
<div class="breadcrumb-wrapper">
    <h4 class="mainTitle no-margin" translate="sidebar.nav.forms.UPLOAD">MULTIPLE FILE UPLOAD</h4>
                                    ...
                                    <div class="panel-body">
                                        <div ng-show="uploaderImages.isHTML5">
                                            ...
                                            <div nv-file-drop="" uploader="uploaderImages" options="{ url: '/foo' }">
                                                <div nv-file-over="" uploader="uploaderImages"
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <div ng-controller="UploadCtrl2" nv-file-drop="" uploader="uploader"
