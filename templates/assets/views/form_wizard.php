...
<div class="breadcrumb-wrapper">
    <h4 class="mainTitle no-margin" translate="sidebar.nav.forms.WIZARD">FORM WIZARD</h4>
                            ...
                            <div id="wizard" class="swMain">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group"
                                                            ...
                                                            <label> First Name <span class="symbol required"></span>
                                                            </label>
                                                            <input type="text" placeholder="Enter your First Name"
                                                                   class="form-control" name="firstName"
                                                                   ng-model="myModel.firstName"
                                                ...
                                                <p>
                                                    <a href
                                                       uib-popover="Your personal information is not required for unlawful purposes, but only in order to proceed in this tutorial"
                                                       popover-placement="top" popover-title="Don't worry!"> Why do you
                                                        need my personal information? </a>
                                                </p>
                                            </fieldset>
                                            <fieldset>
                                                <legend>
                                                ...
                                                <p>
                                                    Enter security questions in case you lose access to your account.
                                                    <span class="text-small block">Be sure to pick questions that you will remember the answers to.</span>
                                                </p>
                                                <uib-accordion close-others="oneAtATime" class="accordion">
                                                    <uib-accordion-group is-open="question1.open">
                                                        <uib-accordion-heading>
                                                            What was the name of your first stuffed animal? <i
                                                                class="pull-right"
                                                                ng-class="{'ti-angle-down': question1.open, 'ti-angle-right': !question1.open}"></i>
                                                        </uib-accordion-heading>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" name="stuffedAnimal"
                                                                   ng-model="myModel.stuffedAnimal"
                                                                   placeholder="Enter the the name of your first stuffed animal">
                                                        </div>
                                                    </uib-accordion-group>
                                                    <uib-accordion-group is-open="question2.open">
                                                        <uib-accordion-heading>
                                                            What is your grandfather's first name? <i class="pull-right"
                                                                                                      ng-class="{'ti-angle-down': question2.open, 'ti-angle-right': !question2.open}"></i>
                                                        </uib-accordion-heading>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                   name="grandfatherName"
                                                                   ng-model="myModel.grandfatherName"
                                                                   placeholder="Enter your grandfather's first name">
                                                        </div>
                                                    </uib-accordion-group>
                                                    <uib-accordion-group is-open="question3.open">
                                                        <uib-accordion-heading>
                                                            In what city your grandmother live? <i class="pull-right"
                                                                                                   ng-class="{'ti-angle-down': question3.open, 'ti-angle-right': !question3.open}"></i>
                                                        </uib-accordion-heading>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                   name="grandmotherCity"
                                                                   ng-model="myModel.grandmotherCity"
                                                                   placeholder="Enter your grandfather's first name">
                                                        </div>
                                                    </uib-accordion-group>
                                                </uib-accordion>
                                ...
                                <div id="step-2" ng-show="currentStep == 2">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="padding-30">
                                                <h2 class="StepTitle">Create an account <span class="text-large block">to manage everything you do with ng-Clip</span>
                                                </h2>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <input type="email" placeholder="Enter a valid E-mail"
                                                           class="form-control" name="email" ng-model="myModel.email"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group"
                                                            ...
                                                            <input type="password" placeholder="Repeat Password"
                                                                   ...
                                                                   ng-model="myModel.password2"
                                                                   compare-to="myModel.password"
                                                                   ng-required="currentStep == 2"/>
                                                            <span class="error text-small block"
                                                            ...
                                                            <span class="success text-small block"
                                                                  ng-if="Form.password2.$valid">Passwords match!</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="padding-30">
                                                ...
                                                <p class="text-large">
                                                    You will need to enter your billing address and select your payment
                                                    method.
                                                </p>
                                                ...
                                                <div class="form-group">
                                                    <div class="btn-group">
                                                        <label class="btn btn-primary btn-sm"
                                                               ng-model="myModel.paymentMethod"
                                                               uib-btn-radio="'creditcard'"> <i
                                                                class="fa fa-cc-visa"></i> <i
                                                                class="fa fa-cc-mastercard"></i> Credit Card </label>
                                                        <label class="btn btn-primary btn-sm"
                                                               ng-model="myModel.paymentMethod"
                                                               uib-btn-radio="'paypal'"> <i class="fa fa-cc-paypal"></i>
                                                            PayPal </label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                            ...
                                                            <div class="col-xs-3">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           ng-model="myModel.securityCode">
                                                                </div>
                                                            </div>
                                                            <span class="help-inline col-xs-4"> <a href
                                                                                                   uib-popover="The security code is a three-digit number on the back of your credit card, immediately following your main card number."
                                                                                                   popover-placement="top"
                                                                                                   popover-title="How to find the security code"><i
                                                                        class="ti-help-alt text-large text-primary"></i></a> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        ...
                                        <div class="col-md-12">
                                            <div class="text-center">
                                                ...
                                                <p class="text-small">
                                                    ...
                                                    completed, and a receipt for your purchase has been emailed to you.
