...
app.controller('dashboardCtrl',["$scope","authFact","$uibModal",
	function($scope,authFact,$uibModal){
		...
		$scope.items = ['ihfghfghfgh', 'ifghfghfghtem2', 'gfhfghfgh'];
		...
		$scope.open = function (size) {
			...
			var modalInstance = $uibModal.open({
				...
				templateUrl: 'settingsXXXContent.html',
